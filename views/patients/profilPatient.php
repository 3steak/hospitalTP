                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            Supprimer le rendez-vous de <?= htmlspecialchars($appointment->lastname) ?> <?= htmlspecialchars($appointment->firstname) ?>, le <?= htmlspecialchars(date('d/m/Y', strtotime($appointment->dateHour))) ?> à <?= htmlspecialchars(date('H:i', strtotime($appointment->dateHour))) ?> ?
                        </div>
